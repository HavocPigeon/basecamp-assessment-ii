...
var me = {firstname:"Easton", age:26, state:"Arizona"};
...
message.text = "You the man"
// #4 Create an object called 'adjustCount' and create two methods. One called 'upVote' and one called 'downVote'. upVote should take in a number and add one to it and downVote should take in a number and minus one from it.

var adjustCount = {upVote:function(num){return num + 1;}, downVote:function(num){return num - 1;}};

// #5 Create an array called 'myFriends' with four of your friends names

var myFriends = ["Humter", "Matt", "Jaron", "Michael"];

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("Preston");
